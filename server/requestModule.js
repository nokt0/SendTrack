...
function fetchYoutube(request, type) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const youtubeOptions = Object.assign({}, const_1.YOUTUBE_OPTIONS);
        let requestUrl = '';
        switch (type) {
            case const_1.RequestType.SEARCH_REQUEST:
                requestUrl = '/search?q=' + artist + ' ' + track;
                break;
            case const_1.RequestType.TRACK_REQUEST:
                requestUrl = '/videos?id=' + id;
                break;
            default:
                throw new IncorrectRequest_1.default("Incorrect request type", request);
        }
        requestUrl += '&part=snippet&key=' + const_1.YOUTUBE_API_KEY;
        ...
        yield node_fetch_1.default(youtubeOptions.url + requestUrl, youtubeOptions)
            ...
            .catch((e) => {
            const error = e;
            error.service = const_1.Services.YOUTUBE;
            throw error;
        });
        return answerObject;
    });
...
function fetchTokenSpotify() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (token.key === '' || Date.now() > token.expires || token.date === 0) {
            ...
            yield node_fetch_1.default(const_1.SPOTIFY_TOKEN_OPTIONS.url, const_1.SPOTIFY_TOKEN_OPTIONS)
                .then((res) => res.json())
                .then((json) => callback(json))
                .catch((e) => {
                const errr = e;
                errr.service = const_1.Services.SPOTIFY;
                throw errr;
            });
            spotifyToken = token;
            return spotifyToken;
...
function fetchSpotify(request, type) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const options = Object.assign(Object.assign({}, const_1.SPOTIFY_OPTIONS), { headers: {
        ...
        yield node_fetch_1.default(options.url, options)
            ...
            .catch((e) => {
            const error = e;
            error.service = const_1.Services.SPOTIFY;
            throw error;
        });
        return answerObject;
    });
...
function fetchDeezer(request, type) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const options = Object.assign({}, const_1.DEEZER_OPTIONS);
        ...
        yield node_fetch_1.default(requestUrl, options)
            ...
            .catch((e) => {
            const error = e;
            error.service = const_1.Services.DEEZER;
            throw error;
        });
        return answerObject;
    });
