...
function everywhere(artistTrack, withoutArr) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!without.includes(const_1.Services.SPOTIFY)) {
            spotify = requestModule_1.fetchSpotify(artistTrack, const_1.RequestType.SEARCH_REQUEST)
                .catch((e) => {
                throw e;
            });
            promisesArr.push(spotify);
        }
        if (!without.includes(const_1.Services.YOUTUBE)) {
            youtube = requestModule_1.fetchYoutube(artistTrack, const_1.RequestType.SEARCH_REQUEST)
                .catch((e) => {
                throw e;
            });
            promisesArr.push(youtube);
        }
        if (!without.includes(const_1.Services.DEEZER)) {
            deezer = requestModule_1.fetchDeezer(artistTrack, const_1.RequestType.SEARCH_REQUEST)
                .catch((e) => {
                throw e;
            });
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (service) {
            case const_1.Services.YOUTUBE:
                let snippet;
                responseObj = yield requestModule_1.fetchYoutube(artistTrack, const_1.RequestType.TRACK_REQUEST).catch((e) => {
                    throw e;
                });
            ...
            case const_1.Services.SPOTIFY:
                responseObj = yield requestModule_1.fetchSpotify(artistTrack, const_1.RequestType.TRACK_REQUEST).catch((e) => {
                    throw e;
                });
            ...
            case const_1.Services.DEEZER:
                responseObj = yield requestModule_1.fetchDeezer(artistTrack, const_1.RequestType.TRACK_REQUEST).catch((e) => {
                    throw e;
                });
